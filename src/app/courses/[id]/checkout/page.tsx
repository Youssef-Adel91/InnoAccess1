            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-white rounded-lg shadow-md overflow-hidden">
                    ...
                    <div className="flex border-b">
                        <button
                            disabled
                            className="relative flex-1 px-6 py-4 font-medium transition-colors opacity-50 cursor-not-allowed bg-gray-100 text-gray-500"
                        >
                            <CreditCard className="h-5 w-5 inline-block mr-2" />
                            Card / Wallet
                            <span className="absolute top-2 right-4 bg-gray-500 text-white text-[10px] px-2 py-0.5 rounded-full shadow-sm">
                                Coming Soon
                            </span>
                        </button>
                        <button
